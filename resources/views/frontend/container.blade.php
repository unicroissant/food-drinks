        ...
        <div class="container">
            <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-8 col-sm-12 text-center ftco-animate">
                    ...
                    <p class="mb-4 mb-md-5">Cambodian food is subtler with its spices. Sturdy ingredients include garlic, lemongrass, kaffir lime leaves, turmeric and galangal, which are usually pounded into a kroeung (paste) and commonly used in cooking.</p>
                    <p><a href="{{url('http://127.0.0.1:8000/shop')}}" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="{{url('http://127.0.0.1:8000/menu')}}"
